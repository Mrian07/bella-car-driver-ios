...
extension UIColor {
    ...
    public struct UCAColor {
        ...
        */
        ...
        public static let AppThemeColor = UIColor(hex: 0x000000)
        public static let AppThemeColor_Dark = UIColor(hex: 0x000000)
        public static let AppThemeColor_Hover = UIColor(hex: 0x000000)
        ...
        */
        ...
        public static let appLoginFieldBorderWidth:CGFloat = 2
