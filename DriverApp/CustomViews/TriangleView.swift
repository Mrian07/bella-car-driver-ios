...
class TriangleView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if(fillColor != nil && unFillColor != nil){
            // Paint the View Blue before drawing the traingle
            //            self.backgroundColor = isMirror ? fillColor : unFillColor
            //            context!.setFillColor(isMirror ? unFillColor.cgColor : fillColor.cgColor)  // Set fill color
            //            self.backgroundColor = isMirror ? fillColor : unFillColor
            
            context!.setFillColor(isMirror ? fillColor.cgColor : unFillColor.cgColor)  // Set fill color
            
            //            if(isMirror){
            //                context!.setFillColor(fillColor.cgColor)  // Set fill color
            //            }else{
            //                context!.setFillColor(unFillColor.cgColor)  // Set fill color
            //            }
        }else{
            // Paint the View Blue before drawing the traingle
