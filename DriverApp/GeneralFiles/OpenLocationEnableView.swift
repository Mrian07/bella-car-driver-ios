...
class OpenLocationEnableView: NSObject, MyLabelClickDelegate, OnLocationUpdateDelegate {
    ...
    func show(){
        ...
        let extraHeight = self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_NO_LOCATION_IPHONE_TXT").height(withConstrainedWidth: width - 30, font: UIFont(name: Fonts().light, size: 16)!) - 20
