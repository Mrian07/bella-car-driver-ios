...
class OpenAdditionalChargesView: NSObject, MyLabelClickDelegate {
    ...
    func show(currentFare:String){
        ...
        let extraHeight = self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_ADDITONAL_CHARGE_HINT").height(withConstrainedWidth: width - 20, font: UIFont(name: Fonts().semibold, size: 17)!)
...
//        let extraHeight = self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_ADDITONAL_CHARGE_HINT").height(withConstrainedWidth: width - 30, font: UIFont(name: Fonts().semibold, size: 17)!)
//
