...
//            super.closeCurrentScreen()
            ...
            if(response != ""){
                ...
                if(dataDict.get("Action") == "1"){
                    ...
                    for i in 0 ..< self.dataArrList.count{
                        ...
                        let docNameHeight = docName.height(withConstrainedWidth: Application.screenSize.width - 103, font: UIFont(name: Fonts().semibold, size: 20)!) - 24
    ...
    @objc func docImgViewTapped(sender:UITapGestureRecognizer){
