...
class HelpQuestionAnswersUV: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        for i in 0 ..< selectedHelpCategoryItem.questionList.count{
            ...
            var answerHeight = item.get("tAnswer").getHTMLString(fontName: Fonts().light, fontSize: "17", textColor: "#676767", text: item.get("tAnswer")).height(withConstrainedWidth: Application.screenSize.width - 40)
