...
//        self.fareDetailsHLbl.textColor = UIColor.UCAColor.AppThemeColor_1
        ...
        let heightFareDetailDisc = (self.fareDetailsDiscLbl.text)!.height(withConstrainedWidth: Application.screenSize.width - 58, font: UIFont(name: Fonts().light, size: 14)!) - 20
