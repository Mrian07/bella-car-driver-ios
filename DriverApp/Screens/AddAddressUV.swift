...
class AddAddressUV: UIViewController, MyBtnClickDelegate {
    ...
    func setData(){
        self.navigationItem.title = self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_WORKLOCATION")
        self.title = self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_WORKLOCATION")
        self.serviceAreaHLbl.text = self.generalFunc.getLanguageLabel(origValue: "Area of service", key: "LBL_AREA_SERVICE_HINT_INFO")
        
        self.serviceAreaVLbl.text = self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_SELECT_ADDRESS_TITLE_TXT")
        ...
        self.addAddressBtn.setButtonTitle(buttonTitle: self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_BTN_SUBMIT_TXT"))
    ...
    func checkData(){
        ...
        self.performSegue(withIdentifier: "unwindToManageWorkLocation", sender: self)
    }
