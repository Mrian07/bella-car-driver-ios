...
//            self.PAGE_HEIGHT = 1100
            ...
            self.tipViewHeight.constant = self.tipViewHeight.constant + (self.tipInfoLbl.text!.height(withConstrainedWidth: Application.screenSize.width - 50, font: UIFont(name: Fonts().light, size: 16)!) - 20)
